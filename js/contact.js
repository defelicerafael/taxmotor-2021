var contacto = (function(){
    ...
    apellido = document.getElementById("apellido_");
    ...
    enviar = function() {
        ...
        xhttp.send("nombre="+name.value+"&email="+email.value+"&telefono="+telefono.value+"&comentario="+textarea.value+"&apellido="+apellido.value);
